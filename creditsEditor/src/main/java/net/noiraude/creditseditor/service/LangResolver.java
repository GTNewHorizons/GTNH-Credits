 ...
 * <li>the {@link CreditsLayout#DEFAULT_LOCALE} document, if loaded.
 * </ol>
 *
 * <p>
...
public final class LangResolver {
    ...
    public @NotNull Optional<String> resolve(@NotNull String key, @NotNull String activeLocale) {
        ...
        if (CreditsLayout.DEFAULT_LOCALE.equals(activeLocale)) return Optional.empty();
        return lookup(CreditsLayout.DEFAULT_LOCALE, key);
    }
